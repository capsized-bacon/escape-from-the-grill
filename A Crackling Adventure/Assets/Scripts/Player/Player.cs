...
=======
        ...
        // Niki @ 08/08/2020 - Adding a goofy way to implement joystick control. Because we're already using x-axis for moving
        // only the jump button needs to be mapped to a controller. Note this has not been tested yet.
